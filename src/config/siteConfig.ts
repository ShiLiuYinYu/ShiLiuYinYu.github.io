...
export const siteConfig: SiteConfig = {
	title: "ShiLiu_YinYu's blog",
	subtitle: "记录学习，分享思考",
	siteURL: "https://shiliuyinyu.github.io/", // 请替换为你的站点URL，以斜杠结尾
	...
	banner: {
		...
		src: {
			desktop: [
				"/assets/desktop-banner/124956717_p0.png",
				"/assets/desktop-banner/133376054_p0.png",
				"/assets/desktop-banner/hiro.jpg",
				"/assets/desktop-banner/nachoneko1.jpg",
				"/assets/desktop-banner/wudununb.jpg",
			], // 桌面横幅图片
			mobile: [
